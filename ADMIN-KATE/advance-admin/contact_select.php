    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">CONTACT SELECT</h1>
                        <h1 class="page-subhead-line">Thông tin của khách hàng</h1>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                            <?php
                                                ...
                                                $contact = $tbl_contact->select_all();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="contact_delete.php?id=<?php echo $contact["contact_id"] ?>">Delete</a>
                                                </td>
                                            </tr>
                                            <?php 
                                                }
