                ...
                <div class="col-lg-9">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        <a href="index.php" class="navbar-brand d-block d-lg-none">
                            <h1 class="m-0 text-primary text-uppercase">Monaco</h1>
                        </a>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <?php 
                        ...
                        $cate = $tbl_category->select_all();
                        $rooms = $tbl_room->select_all();
                        foreach($rooms  as $room) {
                            $category_mota = '';
                            foreach($cate as $category) {
                                if($category['name_category'] == $room['category']) {
                                    $category_mota = $category['mota'];
                                    break;
                                }
                            }
                    ?>
                    <div class="col-lg-4 col-md-6 wow fadeInUp " data-wow-delay="0.1s" >
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                                <img src="../UPLOAD/Admin/<?php echo $room['Hinh_Anh'] ?>" alt="">
                            ...
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0"><?php echo $room['category']?></h5>
                                    <div class="ps-2">
                                ...
                                <div class="d-flex mb-3">
                                    <small class="border-end me-3 pe-3"><i class="fa-solid fa-water-ladder"></i> Pool</small>
                                    <small class="border-end me-3 pe-3"><i class="fa-solid fa-mug-saucer"></i> Breakfast</small>
                                    <small><i class="fa fa-wifi text-primary me-2"></i>Wifi</small>
                                </div>
                                <p class="text-body mb-3 "><?php echo $category_mota ?></p>
                                <div class="d-flex justify-content-between">
                                    <a class="btn btn-sm btn-primary rounded py-2 px-4" href="">View Detail</a>
                                    <?php
                                    // Kiểm tra xem người dùng đã đăng nhập hay chưa
                                        if (!empty($_SESSION["username"])) {
                                            echo '<a class="btn btn-sm btn-dark rounded py-2 px-4" href="booking.php?id=' . $room["room_id"] . '">Book Now</a>';
                                        } else {
